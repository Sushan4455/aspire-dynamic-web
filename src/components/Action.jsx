export default function Action() {
    return (
        <>
            ...
            <div className="max-w-5xl py-16 md:w-full mx-2 md:mx-auto flex flex-col items-center justify-center text-center bg-gradient-to-br from-green-700 via-emerald-600 rounded-2xl p-10 text-white">
                ...
                <button className="px-8 py-3 text-black bg-white hover:bg-slate-700 transition-all rounded-full uppercase text-sm mt-8">
                    Join Now
                </button>
            </div>
        </>
